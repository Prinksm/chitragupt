...
public class ContactAddress {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "contact_address_id_seq")
    @SequenceGenerator(name = "contact_address_id_seq", sequenceName = "contact_address_id_seq", allocationSize = 1)
    private Long id;
